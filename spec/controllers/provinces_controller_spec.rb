...
describe ProvincesController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested province" do
        ...
        put :update, :id => province.id, :province => {'these' => 'params'}
      end

      it "assigns the requested province as @province" do
        province = Province.create! valid_attributes
        put :update, :id => province.id, :province => valid_attributes
        assigns(:province).should eq(province)
      end
    ...
    describe "with invalid params" do
      it "assigns the province as @province" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Province.any_instance.stub(:save).and_return(false)
        put :update, :id => province.id.to_s, :province => {}
        assigns(:province).should eq(province)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested province" do
      province = Province.create! valid_attributes
      expect {
        delete :destroy, :id => province.id.to_s
      }.to change(Province, :count).by(-1)
    end
