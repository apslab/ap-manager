class ProfessionalSpecialitiesController < ApplicationController
  ...
  def create
	...
	flash[:notice] = "Professional Speciality creado con exito." if @professional_speciality.save
    respond_with(@professional_speciality)
  end
  ...
  def update
    @professional_speciality = ProfessionalSpeciality.find(params[:id])
	flash[:notice] = "Professional Speciality actualizado con exito." if @professional_speciality.update_attributes(params[:professional_speciality])
  end

  def destroy
    @professional_speciality = ProfessionalSpeciality.find(params[:id])
    @professional_speciality.destroy
	flash[:notice] = "Professional Speciality borrado con exito." if @professional_speciality.destroy
    respond_with(@professional_speciality)
  end
end
